...
mod tests {
    ...
    fn discriminator_values_are_expected_ascii() {
        // "SentWalt"
        assert_eq!(&SMART_WALLET_DISCRIMINATOR, b"SentWalt");
        // "SentSess"
        assert_eq!(&SESSION_KEY_DISCRIMINATOR, b"SentSess");
        // "SentAgnt"
        assert_eq!(&AGENT_CONFIG_DISCRIMINATOR, b"SentAgnt");
    }
    ...
    fn seeds_are_expected_values() {
        assert_eq!(WALLET_SEED, b"sentinel");
