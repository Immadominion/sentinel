...
- [SetRecoveryThresholdParams](Interface.SetRecoveryThresholdParams.md)
...
- [lockWalletInstruction](Function.lockWalletInstruction.md)
...
- [removeGuardianInstruction](Function.removeGuardianInstruction.md)
- [revokeSessionInstruction](Function.revokeSessionInstruction.md)
- [setRecoveryThresholdInstruction](Function.setRecoveryThresholdInstruction.md)
