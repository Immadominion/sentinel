/**
 * Instruction builders for the Sentinel program.
 *
...
export interface CreateWalletParams {
  ...
  /** Program ID (defaults to SENTINEL_PROGRAM_ID) */
  programId?: PublicKey;
}
...
export function createWalletInstruction(
  ...
  const programId = params.programId ?? SENTINEL_PROGRAM_ID;
...
export function executeViaSessionInstruction(
  ...
  // Build account metas
  const keys = [
    // Required accounts for Sentinel validation
