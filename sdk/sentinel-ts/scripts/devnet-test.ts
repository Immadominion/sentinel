/**
 * Devnet Integration Test for Sentinel Smart Wallet
 *
...
async function main() {
    ...
    console.log("Sentinel Smart Wallet - Devnet Integration Test");
    console.log("=".repeat(60));
    console.log();
    ...
    console.log();
    console.log("Program ID:", SENTINEL_PROGRAM_ID.toBase58());
